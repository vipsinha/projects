...
private:
    ...
    //// STUDENT CODE
    ////
    // VISI: This could be a smart unique pointer
    // VISI: Logic implementation inside this (owned nodes)
    // TASK 1
...
public:
    ...
    ChatLogic *GetChatLogicHandle() { 
        // VISI: Updated to return the raw pointer
...
// VISI: Blue screen appears with answers
...
// VISI: Main frame where we can see questions and answers from logic
class ChatBotFrame : public wxFrame
{
private:
    // control elements
    // VISI: Logic need to be implemented here
...
{
public:
    //VISI: everything starts from here
    // events
    virtual bool OnInit();
};
