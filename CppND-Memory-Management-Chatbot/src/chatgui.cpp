...
void ChatBotFrame::OnEnter(wxCommandEvent &WXUNUSED(event))
{
    ...
    // VISI: send query to chatbot and convert to stl string from WX widget string type
    ...
    : wxScrolledWindow(parent, id)
{
    ...
    // VISI: Since unique pointer, it can not be assigned with raw pointer
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    // VISI: Can't delete the unique pointer.
    // it will be deleted by its  own destructor
  	// TASK 0
    // delete _chatLogic;
